...
const Hero = () => {
  return (
    ...
    >
      {/* Background Glow */}
      <div className="absolute inset-0 bg-gradient-to-r from-orange-500/10 to-red-500/10 blur-3xl pointer-events-none"></div>
      ...
      >
        Hi, I'm <span className="text-orange-500">Om Pimple</span>
      </motion.h1>
      ...
      >
        <a
          ...
          className="bg-green-600 hover:bg-green-700 px-6 py-3 rounded-full transition duration-300"
        >
          GitHub
        </a>
