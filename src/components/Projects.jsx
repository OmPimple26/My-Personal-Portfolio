  ...
  return (
    <section id="projects" className="py-24 bg-black text-white px-6">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-extrabold text-center text-orange-500 mb-14">
          Projects
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="bg-[#111] border border-gray-800 rounded-3xl p-7 shadow-xl hover:border-orange-500 transition duration-300"
            >
              <h3 className="text-2xl font-bold mb-3 text-white">
                {project.title}
              </h3>

              <p className="text-orange-400 text-sm mb-4">{project.tech}</p>
              ...
              <a
                ...
                className="inline-block bg-orange-500 hover:bg-orange-600 px-5 py-2 rounded-full transition duration-300"
              >
                View Project
              </a>
            </motion.div>
