...
const Skills = () => {
  const skills = [
    ...
    { name: "Hibernate", icon: <SiHibernate className="text-yellow-500 text-5xl" /> },
    { name: "Swagger", icon: <SiSwagger className="text-green-400 text-5xl" /> },
    ...
    { name: "Maven", icon: <SiApachemaven className="text-red-400 text-5xl" /> },
  ...
  return (
    <section id="skills" className="py-24 bg-[#0d0d0d] text-white px-6">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-extrabold mb-14 text-pink-500">
          Skills
        </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="bg-[#111] border border-gray-800 hover:border-pink-500 rounded-3xl p-6 flex flex-col items-center shadow-xl transition duration-300"
            >
              {skill.icon}
